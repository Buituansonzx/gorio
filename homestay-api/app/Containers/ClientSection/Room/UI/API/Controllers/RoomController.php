...
use App\Containers\ClientSection\Room\Actions\FindRoomByIdAction;
use App\Containers\ClientSection\Room\Actions\ListRoomsAction;
use App\Containers\ClientSection\Room\Actions\SearchRoomsAction;
use App\Containers\ClientSection\Room\Actions\CheckRoomAvailabilityAction;
use App\Containers\ClientSection\Room\Actions\ListRoomTypesAction;
use App\Containers\ClientSection\Room\Actions\UploadRoomImageAction;
use App\Containers\ClientSection\Room\Actions\CheckTimeoutAction;
use App\Containers\ClientSection\Room\UI\API\Requests\FindRoomByIdRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\ListRoomsRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\SearchRoomsRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\CheckRoomAvailabilityRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\GetRoomTypesRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\UploadRoomImageRequest;
use App\Containers\ClientSection\Room\UI\API\Requests\CheckTimeoutRequest;
use App\Containers\ClientSection\Room\UI\API\Transformers\RoomByIdTransformer;
use App\Containers\ClientSection\Room\UI\API\Transformers\RoomTransformer;
use App\Containers\ClientSection\Room\UI\API\Transformers\RoomTypeTransformer;
...
class RoomController extends ApiController
{
     ...
     *
     * Get a paginated list of available rooms with optional filtering.
     */
    public function listRooms(ListRoomsRequest $request, ListRoomsAction $action): JsonResponse
    {
